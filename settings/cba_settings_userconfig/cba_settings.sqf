...
force awr_ai_painThreshold = 0.5;
...
force awr_player_incapacitationType = 0;
force awr_player_isEnabled = true;
force awr_player_limbHandleMode = 0;
force awr_player_painThreshold = 0.5;
force awr_player_playFallAnimation = true;
force awr_player_weaponHandleMode = 1;
...
BloodLust_IsBloodPoolingEnabled = false;
