...
huron_typename = "TF373_SOAR_MH47G";                       // This is Spartan 01, a multipurpose mobile respawn as a helicopter.
...
air_vehicles = [
    ...
    ["RHS_MELB_AH6M",200,200,100],                                      // AH-6M Pawne
    ["vtx_MH60M_DAP",750,750,250],                                       // AH-64D (Multi-Role))
    ["vtx_MH60M",250,0,150],                                           // UH-60M (Unarmed)
